...
import { Box, Paper, Grid, Switch, FormControlLabel, Typography, IconButton, Slider, CardMedia, CardContent, Card, Chip, Tab, Tabs, MenuItem, range, Select, FormControl } from '@mui/material';
